...
# Plugins
plugins=(common-aliases ssh-agent git git-auto-fetch debian osx systemd sudo docker docker-compose kubectl gradle pip rsync sublime tmux z colorize extract conda zsh-syntax-highlighting)
