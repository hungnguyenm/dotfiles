...
# Plugins
plugins=(common-aliases ssh-agent git git-auto-fetch debian osx systemd sudo docker docker-compose gradle rsync sublime tmux z colorize extract conda zsh-syntax-highlighting)
